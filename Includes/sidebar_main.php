        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark no-print" id="sidenavAccordion">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <a class="nav-link <?php echo $currentPage == 'admin.php' ? 'active' : ''; ?>"
                        href="admin.php?user_id=<?php echo $user_id; ?>">
                        <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                        Dashboard
                    </a>

                    <a class="nav-link <?php echo $currentPage == 'initial_data_entry.php' ? 'active' : ''; ?>"
                        href="initial_data_entry.php?user_id=<?php echo $user_id; ?>">
